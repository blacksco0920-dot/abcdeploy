...
稳定的 MVP 目标允许项目来自电脑里的文件夹或代码仓库地址，并运行在这台电脑或某台 Linux 服务器，因此产品合同覆盖四种组合；各组合当前是否接通和验收，以[当前状态](docs/current-state.md)为准：
...
| `docs` | 当前产品、技术、前端与验收文档，以及隔离的 Comet 变更和历史追溯资产 |
